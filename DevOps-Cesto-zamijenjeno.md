...
- **Kontejner:** pokrenuta inačica slike, sa slojem za pisanje na vrhu. Kad se obriše, taj sloj nestaje, a slika ostaje.
...
- **Always (zadano):** uvijek ponovno pokreće kontejner kad završi. Za servise koji moraju stalno raditi.
- **OnFailure:** ponovno pokreće samo ako je kontejner završio s greškom.
...
- **Provjera na poslužitelju (server):** stroža, kao pri stvaranju objekta (uključuje dodatne provjere), ali bez snimanja. Hvata što lokalna propusti. Vidi LO5 zadatak 40.
